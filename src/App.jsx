...
function App() {
  ...
  return (
    <>
      ...
      <ToDoForm addDetail={addDetail} editDetail={editDetail} editData={editData} />
      <div style={{ display: "flex", margin: 20, flexWrap: "wrap", alignItems: "center" }}>
        <h3 style={{ display: "flex" }}>My Todos</h3>
        <label htmlFor="toDoFilter" style={{ marginLeft: 725 }}><h3>Status Filter : </h3> </label>
        <select name="toDoFilter" id="toDoFilter" style={{ backgroundColor: "grey", color: "white", margin: 5, marginBottom: 10, padding: 5 }}>
